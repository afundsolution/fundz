...
- The Command Center domain UI is now friendly and inactive by default: safe-mode header, status chips, metric cards, readable Daily Board, next queued message previews, top local actions, and a friendly locked-token page for plain-domain visits.
