...
- Production verification on May 13 found the folder parked: no bridge/tunnel/poller/iMessage fallback runtime was active, local health endpoints were not running, and public Cloudflare health returned 530/1033 because no origin/tunnel is connected. Do not claim production portal/app conversation readiness until an approved wake rechecks health and captures one inbound app/portal message proof.
