...
- Latest maintenance autopilot status: `data/local/maintenance-cleanup/fundz-maintenance-autopilot-status.md` (generated 2026-05-08 03:07 CDT; OK; no safety findings; approval required; live sends disabled; selected=0).
