...
- Copy root `AGENTS.md` into FUNDz.
- Copy `memory/` folder structure into FUNDz.
- Copy command shortcuts into FUNDz.
- Copy GitHub Actions memory check workflow into FUNDz.
- Tailor core memory files to FUNDz.
- Run the memory validation check in FUNDz.
- Commit only the new handoff-system files.
- Create private GitHub remote `afundsolution/fundz`.
